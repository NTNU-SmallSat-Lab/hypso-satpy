...
img.save('./composites_out/scene1.png')
...
img.stretch("linear")
img.gamma([gamma, gamma, gamma])
img.save('./composites_out/scene2.png')
...
img.stretch("linear")
img.gamma([gamma, gamma, gamma])
img.save('./composites_out/resampled_scene1.png')
...
img.stretch("linear")
img.gamma([gamma, gamma, gamma])
img.save('./composites_out/resampled_scene2.png')
